...
public class Mercadoria {
	...
	// A QUANTIDADE NÃO É PERSISTIDA EM BANCO, ESSE ATRIBUTO É UTILIZADO PARA GRAVAR ITENS NO PEDIDO
	@Transient
	private int qtd;
	...
	public Mercadoria(String nome, String referencia, Double preco, long codBarras) {
		super();
		this.nome = nome;
		this.referencia = referencia;
		this.preco = preco;
