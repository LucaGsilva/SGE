...
$(document).ready(function () {
    ...
    function Validade() {
        if ($("#Nome").val().trim() == '') {
            document.getElementsByClassName('Mensagem_modal')[0].innerHTML = '<strong>ATENÇÃO !</strong> O nome do cliente deve ser preenchido ';
        ...
        if (validacep.test(cep)) {
            ...
            $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
                ...
                if (!("erro" in dados)) {
                    ...
                    $("#Endereco").val(dados.logradouro + " - " + dados.bairro + " " + dados.complemento);
                    $("#Estado").val(dados.uf);
                }
            });
